(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["chunk-70744eb6"],
  {
    ...
    "1fb5": function(t, e, r) {
      "use strict";
      (e.byteLength = f), (e.toByteArray = l), (e.fromByteArray = g);
      for (
        var n = [],
          i = [],
      ...
      function g(t) {
        for (
          var e, r = t.length, i = r % 3, s = [], o = 16383, a = 0, u = r - i;
          a < u;
          a += o
        )
          s.push(d(t, a, a + o > u ? u : a + o));
        return (
          1 === i
    ...
    "3af4": function(t, e, r) {
      t.exports = r.p + "img/viewed.4b942bb4.png";
    },
    "4b0c": function(t, e, r) {},
    5142: function(t, e, r) {
      "use strict";
      ...
      var n = function() {
          ...
          return n(
            "b-card",
            {
              ...
              staticStyle: { "max-width": "1200px", "min-width": "1000px" },
              attrs: { "no-body": "" },
            },
            [
              n("div", { staticClass: "container" }, [
                n("div", { staticClass: "recipe-body" }, [
                  n("h2", [t._v(t._s(t.recipe.title))]),
                  n("div", { attrs: { id: "recipe-info" } }, [
                    n("span", [
                      n(
                        "div",
                        { staticClass: "info", attrs: { id: "minutes" } },
                        [
                          n("div", { staticClass: "number" }, [
                            t._v(t._s(t.recipe.readyInMinutes)),
                          ]),
                      ...
                      n(
                        "div",
                        { staticClass: "info", attrs: { id: "likes" } },
                        [
                          n("div", { staticClass: "number" }, [
                            t._v(t._s(t.recipe.popularity)),
                          ]),
                          n("div", { staticClass: "description" }, [
                            t._v("likes"),
                          ]),
                      ...
                      n("div", { staticClass: "info" }, [
                        n("div", { staticClass: "number" }, [
                          t._v(t._s(t.recipe.servingSize)),
                        ]),
                        n("div", { staticClass: "description" }, [
                          t._v("Dishes"),
                        ]),
                  ...
                  n("div", { staticClass: "icons" }, [
                    !0 === t.recipe.vegetarian
                      ? n("img", {
                          attrs: {
                            id: "vegetarian",
                            src: r("a4a8"),
                    ...
                    !0 === t.recipe.glutenFree
                      ...
                      : t._e(),
                    !1 === t.recipe.first_time && t.$root.store.username
                      ? n("img", {
                          attrs: {
                            id: "viewed",
                            src: r("3af4"),
                      ...
                      : !0 === t.recipe.first_time
                      ? n("img", {
                          attrs: {
                            id: "viewed",
                            src: r("7a61"),
                            title:
                              "this is the first time you're viewing this recipe",
                          },
                        })
                      : t._e(),
                  ]),
                  t.$root.store.username
                    ? n("div", { attrs: { id: "buttons" } }, [
                        n(
                          "span",
                          {
                            directives: [
                          ...
                          [
                            n(
                              "b-button",
                              {
                                staticClass: "button",
                                attrs: { type: "submit" },
                                on: { click: t.onMakeNow },
                              },
                              [t._v(t._s(t.make_button_text))]
                            ),
                            n(
                              "span",
                              [
                        ...
                        n(
                          "div",
                          {
                            ...
                            attrs: { id: "make-amount" },
                          },
                          [
                            n("h3", [t._v("change the number of dishes")]),
                            n(
                              "div",
                              [
                                n(
                                  "b-button",
                                  {
                                    staticClass: "change-dishes",
                                    attrs: { variant: "outline-danger" },
                                    on: {
                                      click: function(e) {
                                        return t.decrement_dishes();
                                      },
                                    },
                                  },
                                  [t._v("-")]
                            ...
                            n(
                              "b-icon",
                              {
                                ...
                                on: { click: t.backToRecipe },
                              },
                              [
                                t._v(t._s(t.make_button_text)),
                                n("i", { staticClass: "bi bi-camera-video" }),
                              ]
                            ),
                          ],
                          1
                ...
                t.recipe
                  ? n(
                      "div",
                      { staticClass: "recipe-img-container" },
                      [
                        n("img", {
                          staticClass: "center",
                          attrs: { id: "recipe-image", src: t.recipe.image },
                        }),
                        n("FavoriteButton", {
                          attrs: {
                            id: "favoriteButton",
                            recipe: t.recipe.previewInfo,
                          },
                        }),
                      ],
                      1
              ...
              n("div", { staticClass: "divider div-transparent" }),
              n("div", { staticClass: "recipe-full" }, [
                t.onlypreview
                  ? n(
                      "div",
                      ...
                      [
                        n("Instructions", {
                          attrs: { instructions: t.recipe._instructions },
                        }),
                      ],
                      1
                    )
                ...
                n(
                  "div",
                  {
                    ...
                    attrs: { id: "MakingRecipeSteps_div" },
                  },
                  [
                    n("MakingRecipeSteps", {
                      attrs: {
                        instructions: t.recipe._instructions,
                        r_id: t.recipe.id,
                      },
                    }),
                  ],
                ...
                n(
                  "div",
                  { attrs: { id: "ingredients" } },
                  [
                    n("Ingredients", {
                      attrs: {
                        ingredients: t.recipe.extendedIngredients,
                        mul: t.mul_dishes,
                      },
                    }),
                  ],
        ...
        u = function() {
          var t = this,
            ...
            r = t._self._c || e;
          return r("div", [
            r("h1", [t._v("Ingredients:")]),
            r("div", { staticClass: "list" }, [
              r(
                "span",
                { staticClass: "list-item" },
                t._l(t.ingredients, function(e, n) {
                  return r(
                    "div",
                    { key: n + "_" + e.id, staticClass: "info" },
                    [
                      t._m(0, !0),
                      r("div", { staticClass: "item-text" }, [
                        r("div", [
                          t._v(" " + t._s(e.name)),
                          r("span", { attrs: { id: "divider" } }, [t._v("|")]),
                          r("span", { attrs: { id: "amount" } }, [
                            t._v(
                              t._s(Math.floor(e.amount * t.mul * 100) / 100)
                            ),
                          ]),
                          "null" != e.unit
                            ? r("span", [t._v(" " + t._s(e.unit))])
                            : t._e(),
                        ]),
                      ]),
                    ]
        ...
        c = [
          function() {
            var t = this,
              ...
              n = t._self._c || e;
            return n("a", [
              n("img", { staticClass: "bullet", attrs: { src: r("874f") } }),
              n("img", { staticClass: "bullet", attrs: { src: r("acca") } }),
            ]);
          },
        ],
        f =
          (r("a9e3"),
          {
            name: "Ingredients",
            props: {
              ingredients: { type: Array, required: !0 },
              mul: { type: Number, required: !0 },
            },
          }),
        h = f,
        l = (r("606e"), r("2877")),
        p = Object(l["a"])(h, u, c, !1, null, "5a7d3122", null),
        d = p.exports,
        g = function() {
          var t = this,
            e = t.$createElement,
            r = t._self._c || e;
          return r("div", [
            r("h1", [t._v(" Instructions ")]),
            r("div", { staticClass: "wrapped" }, [
              r(
                "div",
                { staticClass: "step" },
                t._l(t.instructions, function(e) {
                  return r(
                    "div",
                    { key: e.number, staticClass: "specific-step" },
                    [
                      r("div", { attrs: { id: "step-title" } }, [
                        t._v("step " + t._s(e.number) + ":"),
                      ]),
                      r("div", { attrs: { id: "step-description" } }, [
                        t._v(t._s(e.step)),
                      ]),
                    ]
                  );
        ...
        v = [],
        y = { name: "Instructions", props: { instructions: { type: Array } } },
        w = y,
        m = (r("aa56"), Object(l["a"])(w, g, v, !1, null, "233fae9f", null)),
        _ = m.exports,
        b = function() {
          var t = this,
            e = t.$createElement,
          ...
          return r(
            ...
            [
              ...
              r(
                "b-progress",
                { attrs: { variant: "success", max: t.max, height: "2rem" } },
                [
                  r(
                    "b-progress-bar",
                    { attrs: { variant: "success", value: t.value } },
                    [
                      r("span", [
                        t._v("Progress: "),
                        r("strong", [
                          t._v(t._s(t.value.toFixed(2)) + " / " + t._s(t.max)),
                        ]),
                      ]),
                    ]
                  ),
              ...
              r("div", { staticClass: "wrapped" }, [
                r(
                  ...
                  t._l(t.steps_todo, function(e) {
                    return r(
                      "li",
                      { key: e.number, staticClass: "list-group-item" },
                      [
                        r("div", { staticClass: "row" }, [
                          r("div", { staticClass: "col" }, [
                            e.isDone
                              ? r("span", [r("del", [t._v(t._s(e.text))])])
                              : r("span", [t._v(t._s(e.text))]),
                          ]),
        ...
        E =
          ...
          r("b639"),
          {
            name: "Instructions",
            props: {
              instructions: { type: Array, required: !0 },
              r_id: { type: Number, required: !0 },
            },
            created: function() {
              (this.max = 0),
            ...
            data: function() {
              return { steps_todo: [], selected: [], max: 0, value: 0 };
            },
            mounted: function() {
              ...
              var t = "",
                e = 0,
                r = !1;
              0 != this.getSessionValue() &&
                ((e = this.getSessionValue()[0]),
                console.log("minStep : " + e),
                (this.value = e),
                console.log("mounted this.value : " + this.value));
              for (var n = 0; n < this.instructions.length; n++)
                (t = "Step "
                  .concat(this.instructions[n].number, ": ")
                  .concat(this.instructions[n].step)),
                  (r = this.instructions[n].number <= e),
                  r &&
                    this.selected.push(parseInt(this.instructions[n].number)),
                  this.steps_todo.push({
                    text: t,
                    value: this.instructions[n].number,
                    isDone: r,
                  });
              console.log(
                "this.steps_todo.length : " + parseInt(this.steps_todo.length)
              ),
                (this.max = parseInt(this.steps_todo.length));
            },
            methods: {
              updateValueProgress: function() {
              ...
              getSessionValue: function() {
                ...
                try {
                  console.log(
                    ...
                    (t = JSON.parse(sessionStorage.making_progress)[this.r_id]),
                    void 0 == t && (t = 0);
                } catch (e) {
                ...
                console.log("this.value : " + this.value),
                  (t.isDone = !0),
                  this.selected.push(parseInt(t.value)),
                ...
                console.log("temp: " + r),
                  void 0 == r && (r = {}),
                  (r[this.r_id] = [this.value, this.steps_todo.length]),
                  sessionStorage.setItem("making_progress", JSON.stringify(r)),
                  (e = sessionStorage.making_progress),
                  console.log("temp1: " + e);
              },
              canClickButton: function(t) {
                var e = this.selected.length;
                return (
                  (1 == t.value && 0 == e) ||
                  parseInt(t.value) - this.selected[e - 1] == 1
                );
              },
            },
            computed: {
              state: function() {
                ...
                var t = this.selected.length;
                return 1 == t
                  ? (this.updateValueProgress(), !0)
                  : 0 == t ||
                      (console.log(parseInt(this.selected[t - 1])),
                      parseInt(this.selected[t - 1]) -
                        parseInt(this.selected[t - 2]) ==
                        1 && (this.updateValueProgress(), !0));
              },
            },
          }),
        I = E,
        R = (r("0e96"), Object(l["a"])(I, b, A, !1, null, "85f92dfe", null)),
        S = R.exports,
        C = {
          components: {
            FavoriteButton: a["a"],
                    ...
                    while (1)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (e.prev = 0),
                            t.$route.query.isPersonal
                              ? (console.log("personal"),
                                (r = "http://localhost:3000/users/personal/"))
                              : (console.log("not personal"),
                                (r = "http://localhost:3000/recipes/")),
                            (e.prev = 2),
                            (e.next = 5),
                            t.axios
                              .create({ withCredentials: !0 })
                              .get(r + t.$route.params.recipeId)
                          );
                        case 5:
                          (n = e.sent),
                            200 !== n.status && t.$router.replace("/NotFound"),
                            (e.next = 14);
                          break;
                        case 9:
                          return (
                            ...
                            t.$router.replace("/NotFound"),
                            e.abrupt("return")
                          );
                        case 14:
                          console.log(n.data),
                            (i = n.data),
                            (o = i.analyzedInstructions),
                            (a = i.extendedIngredients),
                            (u = i.previewInfo),
                            (c = i.first_time),
                            (f = n.data.previewInfo),
                            (h = f.id),
                            (l = f.popularity),
                            (p = f.readyInMinutes),
                            (d = f.image),
                            ...
                            (E = {
                              _instructions: A,
                              analyzedInstructions: o,
                              extendedIngredients: a,
                              popularity: l,
                              readyInMinutes: p,
                              image: d,
                              title: g,
                            ...
                            (null !== t.readyInMinutes &&
                              void 0 !== t.readyInMinutes) ||
                              (t.readyInMinutes = "0"),
                            (null !== b && void 0 !== b) || (t.servingSize = 0),
                            (t.recipe = E),
                            (e.next = 28);
                          break;
                        case 25:
          ...
          methods: {
            ...
            backToRecipe: function() {
              (this.onlypreview = !0), (this.make_button_text = "Make Now");
            },
            decrement_dishes: function() {
              this.recipe.servingSize > 0 &&
                ((this.recipe.servingSize -= 1), (this.mul_dishes -= 1));
            },
            increment_dishes: function() {
              (this.recipe.servingSize += 1), (this.mul_dishes += 1);
            },
            addToMeal: function() {
              var t = this;
                    ...
                    function(e) {
                      while (1)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (t.addToMealLabel = "Added"),
                              (r = "http://localhost:3000/users/upcomingMeal/"),
                              console.log(
        ...
        P = C,
        T = (r("5142"), Object(l["a"])(P, n, i, !1, null, "320734bc", null));
      e["default"] = T.exports;
    },
    7156: function(t, e, r) {
      var n = r("861d"),
    ...
    "7a61": function(t, e, r) {
      t.exports = r.p + "img/new.86530a71.png";
    },
    "874f": function(t, e, r) {
      t.exports = r.p + "img/peach.e29413d4.png";
    },
    9152: function(t, e) {
        ...
        { target: "Array", proto: !0, forced: _ },
        {
          concat: function(t) {
            ...
            for (e = -1, n = arguments.length; e < n; e++)
              if (((s = -1 === e ? o : arguments[e]), m(s))) {
                if (((i = u(s.length)), l + i > g)) throw TypeError(v);
                for (r = 0; r < i; r++, l++) r in s && c(h, l, s[r]);
              } else {
                if (l >= g) throw TypeError(v);
                c(h, l++, s);
              }
            return (h.length = l), h;
          },
        ...
        b = function(t) {
          ...
          if ("string" == typeof c && c.length > 2)
            if (((c = v(c)), (e = c.charCodeAt(0)), 43 === e || 45 === e)) {
              ...
              for (s = c.slice(2), o = s.length, a = 0; a < o; a++)
                if (((u = s.charCodeAt(a)), u < 48 || u > i)) return NaN;
              return parseInt(s, n);
            }
          return +c;
        };
      if (s(y, !w(" 0o1") || !w("0b1") || w("+0x1"))) {
        for (
          var A,
            E = function(t) {
          ...
          a(w, (A = I[R])) && !a(E, A) && g(E, A, d(w, A));
        (E.prototype = m), (m.constructor = E), o(i, y, E);
      }
    },
    aa56: function(t, e, r) {
      "use strict";
    ...
    acca: function(t, e, r) {
      t.exports = r.p + "img/peach-hover.fb9138c9.png";
    },
    b009: function(t, e, r) {},
    b639: function(t, e, r) {
      "use strict";
      (function(t) {
        ...
        function p(t, e) {
          if ((h(e), (t = u(t, e < 0 ? 0 : 0 | w(e))), !c.TYPED_ARRAY_SUPPORT))
        ...
        function E(t, e, r, n, i) {
          ...
          if (("string" === typeof e && (e = c.from(e, n)), c.isBuffer(e)))
            return 0 === e.length ? -1 : I(t, e, r, n, i);
          if ("number" === typeof e)
            return (
              (e &= 255),
              c.TYPED_ARRAY_SUPPORT &&
        ...
        function I(t, e, r, n, i) {
          ...
          if (i) {
            var f = -1;
            for (s = r; s < a; s++)
              if (c(t, s) === c(e, -1 === f ? 0 : s - f)) {
                if ((-1 === f && (f = s), s - f + 1 === u)) return f * o;
              } else -1 !== f && (s -= s - f), (f = -1);
          } else
        ...
        function j(t, e, r, n, s) {
          return (
            s || $(t, e, r, 4, 34028234663852886e22, -34028234663852886e22),
        ...
        function q(t, e, r, n, s) {
          return (
            s || $(t, e, r, 8, 17976931348623157e292, -17976931348623157e292),
        ...
        (c.prototype.slice = function(t, e) {
          ...
          (c.prototype.writeUIntLE = function(t, e, r, n) {
            ...
            var s = 1,
              o = 0;
            this[e] = 255 & t;
            while (++o < r && (s *= 256)) this[e + o] = (t / s) & 255;
            return e + r;
          }),
          ...
          (c.prototype.fill = function(t, e, r, n) {
            ...
            if (
              ...
              var o = c.isBuffer(t) ? t : H(new c(t, n).toString()),
                a = o.length;
        ...
        var J = /[^+\/0-9A-Za-z-_]/g;
        function X(t) {
          if (((t = G(t).replace(J, "")), t.length < 2)) return "";
        ...
        function Q(t, e) {
          for (var r, n, i, s = [], o = 0; o < t.length; ++o) {
            if ((e -= 2) < 0) break;
            (r = t.charCodeAt(o)),
              (n = r >> 8),
              (i = r % 256),
    ...
    c20d: function(t, e, r) {
      var n = r("da84"),
        ...
        o = n.parseInt,
        a = /^[+-]?0[Xx]/,
        u = 8 !== o(s + "08") || 22 !== o(s + "0x16");
      t.exports = u
        ? function(t, e) {
            var r = i(String(t));
            return o(r, e >>> 0 || (a.test(r) ? 16 : 10));
          }
        : o;
    },
    c775: function(t, e, r) {},
    ca91: function(t, e, r) {
      t.exports = r.p + "img/gluten-free2.39d09131.png";
    },
    d58f: function(t, e, r) {
      var n = r("1c0b"),
        i = r("7b0b"),
        ...
        a = function(t) {
          return function(e, r, a, u) {
            ...
            for (; t ? l >= 0 : h > l; l += p) l in f && (u = r(u, f[l], l, c));
            return u;
          };
        };
...
//# sourceMappingURL=chunk-70744eb6.94443a79.js.map
